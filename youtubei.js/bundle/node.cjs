...
var Platform = class {
  static load(platform) {
    (0, import_tslib55.__classPrivateFieldSet)(_a2, _a2, platform, "f", _Platform_shim);
  }
  static get shim() {
    if (!(0, import_tslib55.__classPrivateFieldGet)(_a2, _a2, "f", _Platform_shim)) {
      throw new Error("Platform is not loaded");
    }
    return (0, import_tslib55.__classPrivateFieldGet)(_a2, _a2, "f", _Platform_shim);
  }
};
...
var OAuth2 = class {
  constructor(session) {
    ...
    (0, import_tslib57.__classPrivateFieldSet)(this, _OAuth2_session, session, "f");
  ...
  init(tokens) {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      if (tokens) {
        ...
        (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth", { credentials: this.oauth2_tokens });
        return;
      }
      const loaded_from_cache = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_instances, "m", _OAuth2_loadFromCache).call(this);
      ...
      (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth-pending", device_and_user_code);
  ...
  cacheCredentials() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      yield (_a4 = (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.set("youtubei_oauth_credentials", data.buffer);
    });
  }
  removeCache() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      var _a4;
      yield (_a4 = (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.remove("youtubei_oauth_credentials");
    });
  }
  pollForAccessToken(device_and_user_code) {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      const connInterval = setInterval(() => (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
        const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_instances, "a", _OAuth2_http_get).fetch_function(this.AUTH_SERVER_TOKEN_URL, {
        ...
        if (response_data.error) {
          switch (response_data.error) {
            case "access_denied":
              (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth-error", new OAuth2Error("Access was denied.", response_data));
              clearInterval(connInterval);
              break;
            case "expired_token":
              (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth-error", new OAuth2Error("The device code has expired.", response_data));
              clearInterval(connInterval);
              break;
            ...
            case "slow_down":
              ...
              break;
            default:
              (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth-error", new OAuth2Error("Server returned an unexpected error.", response_data));
              clearInterval(connInterval);
              break;
          }
          return;
  ...
  revokeCredentials() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      return (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").http.fetch_function(url, { method: "POST" });
    });
  }
  refreshAccessToken() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("update-credentials", { credentials: this.oauth2_tokens });
    });
  }
  getDeviceAndUserCode() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_instances, "a", _OAuth2_http_get).fetch_function(this.AUTH_SERVER_CODE_URL, {
        body: JSON.stringify(payload),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  getClientID() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      const yttv_response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_instances, "a", _OAuth2_http_get).fetch_function(this.YTTV_URL, {
        headers: {
      ...
      if ((script_url_body = Constants_exports.OAUTH.REGEX.TV_SCRIPT.exec(yttv_response_data)) !== null) {
        ...
        const script_response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_instances, "a", _OAuth2_http_get).fetch(script_url_body[1], { baseURL: Constants_exports.URLS.YT_BASE });
...
_OAuth2_session = /* @__PURE__ */ new WeakMap(), _OAuth2_instances = /* @__PURE__ */ new WeakSet(), _OAuth2_loadFromCache = /* @__PURE__ */ __name(function _OAuth2_loadFromCache2() {
  return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
    var _a4;
    const data = yield (_a4 = (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.get("youtubei_oauth_credentials");
    if (!data)
      return false;
    const decoder = new TextDecoder();
    const credentials = JSON.parse(decoder.decode(data));
    this.setTokens(credentials);
    (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").emit("auth", { credentials });
    return true;
  });
}, "_OAuth2_loadFromCache"), _OAuth2_http_get = /* @__PURE__ */ __name(function _OAuth2_http_get2() {
  return (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth2_session, "f").http;
}, "_OAuth2_http_get");
    ...
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if ((0, import_tslib58.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !this.session.logged_in)
...
var Player = class {
  ...
  static create(cache_1) {
    return (0, import_tslib59.__awaiter)(this, arguments, void 0, function* (cache, fetch = Platform.shim.fetch) {
  ...
  static extractNSigSourceCode(data) {
    ...
    Log_default.warn(TAG4, "Failed to extract n-token decipher algorithm");
...
var Session = class extends EventEmitterLike_default {
  ...
  static create() {
    return (0, import_tslib60.__awaiter)(this, arguments, void 0, function* (options = {}) {
  ...
  static getSessionData() {
    return (0, import_tslib60.__awaiter)(this, arguments, void 0, function* (lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch, on_behalf_of_user, cache, enable_session_cache = true) {
      ...
      if (!session_data) {
        ...
        if (!generate_session_locally) {
          try {
            const sw_session_data = yield (0, import_tslib60.__classPrivateFieldGet)(this, _a3, "m", _Session_getSessionData).call(this, session_args, fetch);
        ...
        session_data = {
          api_key,
          api_version,
          context: (0, import_tslib60.__classPrivateFieldGet)(this, _a3, "m", _Session_buildContext).call(this, context_data)
        };
        if (enable_session_cache)
          yield (0, import_tslib60.__classPrivateFieldGet)(this, _a3, "m", _Session_storeSession).call(this, session_data, cache);
      }
...
_a3 = Session, _Session_storeSession = /* @__PURE__ */ __name(function _Session_storeSession2(session_data, cache) {
  ...
  return (0, import_tslib60.__awaiter)(this, arguments, void 0, function* (options, fetch = Platform.shim.fetch) {
...
var Music = class {
  ...
  search(query_1) {
    return (0, import_tslib62.__awaiter)(this, arguments, void 0, function* (query, filters = {}) {
  ...
  getUpNext(video_id_1) {
    return (0, import_tslib62.__awaiter)(this, arguments, void 0, function* (video_id, automix = true) {
      var _a4, _b, _c;
...
var Studio = class {
  ...
  upload(file_1) {
    return (0, import_tslib63.__awaiter)(this, arguments, void 0, function* (file, metadata = {}) {
      if (!(0, import_tslib63.__classPrivateFieldGet)(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
...
var InteractionManager = class {
  ...
  translate(text_1, target_language_1) {
    return (0, import_tslib66.__awaiter)(this, arguments, void 0, function* (text, target_language, args = {}) {
...
var Innertube = class {
  ...
  static create() {
    return (0, import_tslib67.__awaiter)(this, arguments, void 0, function* (config = {}) {
  ...
  search(query_1) {
    return (0, import_tslib67.__awaiter)(this, arguments, void 0, function* (query, filters = {}) {
      throwIfMissing({ query });
  ...
  getStreamingData(video_id_1) {
    return (0, import_tslib67.__awaiter)(this, arguments, void 0, function* (video_id, options = {}) {
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "10.1.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
