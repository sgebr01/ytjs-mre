...
class Innertube {
    ...
    getShortsWatchItem(short_id, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const watchResponse = this.actions.execute(Reel.WatchEndpoint.PATH, Reel.WatchEndpoint.build({
                short_id: short_id,
                client: client
            }));
            const sequenceResponse = this.actions.execute(Reel.WatchSequenceEndpoint.PATH, Reel.WatchSequenceEndpoint.build({
