...
export function encodeChannelAnalyticsParams(channel_id) {
...
export function encodeMessageParams(channel_id, video_id) {
...
export function encodeCommentsSectionParams(video_id, options = {}) {
    const sort_options = {
        TOP_COMMENTS: 0,
        NEWEST_FIRST: 1
    };
...
export function encodeCommentParams(video_id) {
...
export function encodeNotificationPref(channel_id, index) {
...
export function encodeVideoMetadataPayload(video_id, metadata) {
    const data = {
        context: {
            client: {
                nameId: 3,
...
export function encodeCustomThumbnailPayload(video_id, bytes) {
    const data = {
        context: {
            client: {
                nameId: 3,
...
export function encodeHashtag(hashtag) {
...
export function encodeReelSequence(short_id) {
